...
import { Wrench, Calendar, AlertTriangle, CheckCircle2, Clock, Search, Filter, Plus } from 'lucide-react';
...
const mockMaintenanceRecords: MaintenanceRecord[] = [
  {
    ...
    description: 'Quarterly maintenance check and battery replacement',
  ...
  },
  {
    ...
    description: 'Motor malfunction investigation and repair',
  ...
  },
  {
    ...
    description: 'Pre-flight safety inspection',
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-gray-500">Schedule and track drone maintenance operations</p>
      </div>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-gray-500 truncate">Urgent Repairs</dt>
                ...
                <tr key={record.id} className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex flex-col">
                      ...
                      <div className="text-sm text-gray-500">{record.droneId}</div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${getTypeColor(record.type)}`}>
                      {record.type}
                    </span>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
